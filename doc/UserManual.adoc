...
Floating point numbers are stored as Ruby's Float with precision specified by PRECISION option and printed with decimal places specified by DECIMALS option.
...
The DECIMALS option sets the number of decimal places printed; trailing zeros are removed.
