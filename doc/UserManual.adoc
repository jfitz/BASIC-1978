...
Each unit is a text followed by an optional number.
The text of units is defined by the programmer.
Any arbitrary text may be used.
...
|123456789{mi s-1} |miles per second
|1.03{Kcal} |Kilocalories
|-2.17{m s-2} |meters per second per second
|1E4{KPa} |Kilopascals
|-2E3{USD} |US dollars
|1E-2{USD} |
|2.37E+4{A} |Amps
