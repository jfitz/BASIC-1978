...
|RND$(i) |string |Return a string of length n, consting of random uppercase letters.
|RND$() |string |Equivalent to RND$(6).
|RND$ |string |Special form of RND$, equivalent to RND$(6).
