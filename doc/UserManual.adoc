...
BASIC-1978 will not run every program that can run in BASIC-1978.
...
|WARN_LIST_WIDTH |N |numeric 0 to 132 |80 |Sets the limit for program lines as shown by LIST; 0 disables warnings
|WARN_PRETTY_WIDTH |N |numeric 0 to 132 |80 |Sets the limit for program lines as shown by PRETTY; 0 disables warnings
