...
340 REM PRINT TABLEAU WITH ROW EVALUATIONS
341 PRINT
...
374 PRINT " ", "Z-C",
375 ARR PRINT Y
376 PRINT "KEY COLUMN";J0;"VARIABLE ";C$(J0);" ENTERS"

380 REM IDENTIFY KEY ROW
381 I0 = 0
382 M = 1E6
383 FOR I = 1 TO N2
...
441 FOR I = 1 TO N2
442   IF I = I0 THEN 444
443   B(I) = B(I) - X(I,J0)*B(I0)/X(I0,J0)
444 NEXT I
445 B(I0) = B(I0) / X(I0,J0)

450 REM SWAP IN THE NEW MATRIX
451 MAT X = X2
452 GOTO 200
