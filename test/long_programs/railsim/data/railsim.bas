...
92 DATA 17
93 DATA 0, 5.6E3, 13.53E3, 16.7E3, 18.2E3, 20.4E3, 24.6E3, 26.6E3, 29.3E3, 33.6E3, 35.6E3, 37.3E3, 39.6E3, 42.6E3, 44.9E3, 46.8E3, 49.1E3
94 DATA "HOBOKEN", "SEACAUCUS", "RUTHERFORD", "WESMONT", "GARFIELD", "PLAUDERVILLE", "BROADWAY", "RADBURN", "GLEN ROCK", "RIDGEWOOD", "HO_HO_KUS"
95 DATA "WALDWICK", "ALLENDALE", "RAMSEY", "RAMSEY RT17", "MAHWAH", "SUFFERN"
96 REM NUMBER OF TRACK SPEED SIGNS, POSITIONS (in meters) AND VALUES
97 DATA 7
98 DATA 0,5, 1.0E3,30, 1.5E3,50, 2.0E3,30, 2.5E3,80, 5.7E3,40, 6.0E30,80
100 REM ***** STATIONS
101 READ K0
110 DIM K(K0), K$(K0)
111 ARR READ K,K$
...
1201 LET V8 = V9
1202 FOR I = 1 TO K0
1203 IF X < K(I) AND X + X5 >= K(I) THEN 1205
1204 GOTO 1207
1205 LET V8 = 0
1206 LET S$ = "APPROACHING " + K$(I)
1207 NEXT I
1210 REM *** SET MAX SPEED FROM SIGNAL
1211 LET V7 = V9
1212 FOR I=1 TO P0
1213 IF P(I,1) > X0 AND P(I,1) <= X THEN 1215
1214 GOTO 1219
1215 LET V7 = P(I,2)
1219 NEXT I
